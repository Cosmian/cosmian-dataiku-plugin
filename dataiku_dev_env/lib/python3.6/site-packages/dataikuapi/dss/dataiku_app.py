...
class DSSDataikuApp(object):
    """
    A handle to interact with a Dataiku App
    Do not create this class directly, instead use :meth:`dataikuapi.DSSClient.get_dataiku_app``
    """
